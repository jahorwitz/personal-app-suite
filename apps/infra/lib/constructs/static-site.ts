...
export interface StaticSiteProps {
  /**
   * Environment name (development, prod)
   */
  environmentName: string;

  /**
   * Domain name for the site (e.g., app.withjosh.net, storybook.withjosh.net)
   */
  domainName: string;

  /**
   * Hosted zone name (e.g., withjosh.net)
   */
...
export class StaticSite extends Construct {
  ...
  /**
   * The full website URL (e.g., https://withjosh.net)
   */
  ...
  constructor(scope: Construct, id: string, props: StaticSiteProps) {
    ...
    this.bucket = new s3.Bucket(this, "Bucket", {
      bucketName: `${environmentName}-${siteName}-jahorwitz-io`,
